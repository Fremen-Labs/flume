        ...
        out.append(
            {
                ...
                "models": models,
                "allowCustomModelId": current in ("ollama", "openai_compatible", "xai"),
                "hint": None
                if settings_ok
        ...
        out.append(
            {
                ...
                "keySuffix": ks,
                "models": models,
                "allowCustomModelId": pid in ("ollama", "openai_compatible", "xai"),
                "hint": hint,
            }
        )
...
def _custom_model_ok(provider_id: str, model_id: str) -> bool:
    ...
    if not re.match(r"^[\w.\-:/]+$", mid):
        return False
    return provider_id in ("ollama", "openai_compatible", "xai")
