...
echo ""
echo "Flume is set up and the dashboard is running in the background."
echo ""
echo "Open the web interface and finish provider setup in Settings:"
echo "  http://localhost:8765"
echo "  Settings → LLM → add API keys or configure your preferred provider"
echo ""
echo "Optional: use ChatGPT / Codex subscription OAuth instead of an API key:"
echo "  Browser-based host:  ./flume codex-oauth login-browser"
echo "  Headless host:       ./flume codex-oauth login-paste --write-html /tmp/flume-oauth.html"
echo ""
